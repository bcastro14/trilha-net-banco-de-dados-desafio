...
-- Correção: incluindo Duracao conforme no screenshot do desafio.
...
-- Correção: impossível ordenar pela Duracao, pois não faz parte da query, então ordenando pela Quantidade.
...
-- Correcao: Incluindo Id, conforme no screenshot do desafio.
